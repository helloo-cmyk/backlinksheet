              ...
              >
                ...
                <div className="w-full aspect-[16/9] relative border-b border-[var(--hp-border)] overflow-hidden bg-[var(--hp-surface)]">
                  ...
                  <div className="absolute top-4 left-4 z-10 flex gap-2">
                    ...
                    {post.isPinned && (
                      <span className="inline-block px-3 py-1.5 bg-black/90 backdrop-blur-sm text-white text-[11px] font-extrabold uppercase tracking-widest rounded-md shadow-sm border border-white/10 flex items-center gap-1">
